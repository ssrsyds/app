...
const cn = {
  WIP: "该功能仍在开发中……",
  Error: {
    Unauthorized: "本程序基于ChatGPT-4开发的聊天服务，首次使用需获取授权码激活设备方可使用，💯[点击前往获取](https://imgbed.link/file/22797)💯，本程序答案响应速度远超市面上的ChatGPT,我可以完成很多项目，例如论文大纲编写，数学公式，英语翻译，论文降重，情感答疑，代码编写，写作辅助，SEO，辩论演讲导师等等功能...【💻AI使用效果预览💻】[立即预览](http://v.yjie.fun/zs/)",
  },
  ChatItem: {
  ...
  Store: {
    ...
    BotHello: "APP端口:已连接----您好！有什么可以帮助你的吗？",
    Error: "出错了，稍后重试吧",
    Prompt: {
